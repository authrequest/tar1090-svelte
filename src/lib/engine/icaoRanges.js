// icaoRanges.js - ICAO address range to country code mapping
// Ported from upstream tar1090 html/flags.js

// ICAO registration address ranges and country
...
const ICAO_Ranges = [
	...
	{ start: 0x901000, end: 0x9017FF, country: "Cook Islands", country_code: "ck" },
...
/**
 * Given an ICAO address (hex string), return an object describing that ICAO range.
 * Always returns a non-null object.
 * @param {string} icao - ICAO address as hex string (e.g., "A12345")
 * @returns {Object} Object with country and country_code properties
 */
export function findICAORange(icao) {
	const hexa = parseInt(icao.replace('~', '1'), 16);
	
	// Search through ranges (more specific ranges should come first)
